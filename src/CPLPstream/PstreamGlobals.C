...
DynamicList<bool> Foam::PstreamGlobals::pendingMPIFree_;
DynamicList<MPI_Comm> Foam::PstreamGlobals::MPICommunicators_;
DynamicList<MPI_Request> Foam::PstreamGlobals::outstandingRequests_;
