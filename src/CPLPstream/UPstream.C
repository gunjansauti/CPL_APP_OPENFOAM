...
)
{
    ...
    if (parentIndex == -1)
    {
        ...
        // TBD: MPI_Comm_dup(Foam::PstreamGlobals::CPLRealmComm, ...);
    ...
    else if (parentIndex == -2)
    {
        ...
        // Uses Foam::PstreamGlobals::CPLRealmComm in case called before UPstream::commGlobal()
        // was initialized

        procIDs_[index].resize_nocopy(1);
        MPI_Comm_rank(Foam::PstreamGlobals::CPLRealmComm, &procIDs_[index].front());
    }
    else
    {
